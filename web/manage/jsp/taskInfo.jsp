        ...
        <div title="纳税人信息" data-options="closable:false" class="basic-info">
            ...
            <table class="kv-table">
                ...
                <tr>
                    ...
                    <td class="kv-content"><label>${requestScope.s.taskName }</label></td>
                    <td class="kv-label">下达部门</td>
                    <td class="kv-content"><label>${requestScope.or1.organName }</label></td>
                    <td class="kv-label">批准人</td>
                    <td class="kv-content"><label>${requestScope.taxer1.taxerName }</label></td>
                </tr>
               
                <tr>
                	<td class="kv-label">执行人</td>
                    <td class="kv-content"><label>${requestScope.taxer2.taxerName }</label></td>
                 	<td class="kv-label">执行时间</td>
                    <td class="kv-content"><label>${requestScope.s.executeTime }</label></td>
                    
                    <td class="kv-label">任务执行情况</td>
                    <td class="kv-content">
                        <textarea rows="3" readonly style="width: 90%;">${requestScope.s.taskState }</textarea>
                    </td>
                </tr>
                </tbody>
            </table>
