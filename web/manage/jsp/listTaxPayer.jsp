         ...
         /**
           ...
           function removeTaxPayer(id){
        	   $.messager.confirm('操作提示', '确定要删除吗?', function(r){
	  				if (r){
	  					$.post("TaxDeleteServlet",{"id":id},function(data){
			           		if(data.success){
			           			alert(data.msg)
			           			doSearch()	
			           		}else{
           ...
           //详情![](C:/Users/hui/Desktop/新建文件夹/屏幕截图 2021-10-20 100625.png)
           function detail(id){
	           	openTopWindow({"url":"SelectIDServlet?id="+id,
	   		 	"title":"纳税人信息",	   		 	
	   		 	 width : 750,
                 height : 500,
				})
           ...
           //更新
    		function edit(id){	          
	   		 	openTopWindow({url:"TaxUpDateServlet?id="+id,
	   		 	title:"修改纳税人信息",	   		 	
	   		 	 width : 750,
                 height : 600,
				})
           ...
           //新建任务
           function addTask(id){ 
           		parent.addTab("调查任务录入","QueryServlet?id="+id)
           }
