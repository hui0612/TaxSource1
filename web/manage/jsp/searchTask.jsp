...
<link rel="stylesheet" type="text/css" href="../../static/easyui/uimaker/icon.css">
  ...
  <script type="text/javascript">
    ...
    *   添加处理函数
     ...
     //查询任务详细信息
     function detail(id){    	           
	    openTopWindow({"url":"DetailsServlet?id="+id,
	   	"title":"任务信息",	   		 	
	   	 width : 750,
         height : 600,
		})
     ...
     //修改任务详细
     function edit(id){
     	openTopWindow({url:"updateServlet?id="+id,
	   		  title:"修改任务信息",	   		 	
	   		  width : 850,
              height : 700,
		})
 	...
 	//查询操作函数定义
    function doSearch(){  
		$("#dg").datagrid("reload","SelectSourceServlet?"+$("#conForm").serialize())
	}
  </script>
  <body>
     <div class="container">
      ...
      <form id="conForm">
        <div class="conditions">
            ...
            <select name="organName" style="width:166px;height:35px;line-height:35px;">
            ...
            <select  name="industryName" style="width:166px;height:35px;line-height:35px;">
                   ...
                   <c:forEach items="${requestScope.ind }" var="industry">
    ...
    $(function(){
       	   $("#dg").datagrid({
	       	   ...
	       	   columns:[[
                    ...
                    {field:"timeOutfrom","title":"录入超时(天)"},
